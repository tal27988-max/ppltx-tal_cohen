...
python ./project/db_monitor/daily_db_monitor_update_03.py
python ./project/db_monitor/daily_db_monitor_update_03.py my-project-ppltx-sql --table_override
python ./project/db_monitor/daily_db_monitor_update_03.py bigquery-public-data --table_override
